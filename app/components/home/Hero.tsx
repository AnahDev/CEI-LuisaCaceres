  ...
  return (
    <section className="max-w-7xl mx-auto px-6 mb-24 mt-8 relative font-['Plus_Jakarta_Sans']">
      <div className="relative rounded-xl overflow-hidden shadow-[0_8px_40px_rgba(48,51,48,0.08)] bg-[#f4f4f0] h-[600px] flex items-center justify-center">
        ...
        <div className="relative诚 z-20 text-center px-8 md:px-16 lg:w-2/3 mx-auto flex flex-col items-center gap-8">
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 z-30">
          {CAROUSEL_SLIDES.map((_, idx) => (
            <button
              ...
              className={`w-3 h-3 rounded-full shadow-sm transition-all duration-300 outline-none ${
                idx === currentSlide 
                  ? 'bg-[#ffffff] scale-125' 
