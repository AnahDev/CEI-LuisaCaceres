...
export default function BottomActionBar({ onSaveDraft, onPublish, publishing = false }: BottomActionBarProps) {
  return (
    <div className="fixed bottom-0 left-0 md:left-72 right-0 bg-[rgba(250,249,246,0.8)] backdrop-blur-2xl border-t border-[rgba(177,178,175,0.1)] p-4 px-8 z-30">
